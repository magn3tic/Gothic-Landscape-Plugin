<?php
/**
 * Post Table Pro Custom Data Type - Community
 *
...
use Gothic\Selections\PostType\Community;
 ...
 * @license GPL-3.0
 */
final class OrderCommunity extends Abstract_Table_Data {
	...
	public function get_data() {
		...
		$community_id = get_post_meta( $this->post->ID, 'community_id', true );

		if ( ! $community_id || ! Community::is_post_of_type( $community_id ) ) {
			return '';
		}
