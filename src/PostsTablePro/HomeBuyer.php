 ...
 * @license GPL-3.0
 */
final class HomeBuyer extends Abstract_Table_Data {
	...
	public function get_data() {
		...
		$home_buyer = get_post_meta( $this->post->ID, 'home_buyer', true ) ?: get_post_meta( $this->post->ID, 'email', true );

		if ( ! $home_buyer ) {
			return '';
		}

		return esc_html( $home_buyer );
	}
}