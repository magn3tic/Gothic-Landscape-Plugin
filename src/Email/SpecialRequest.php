 ...
 * @abstract
 */
final class SpecialRequest extends MessageAbstract implements MessageInterface {
	 ...
	 * @var string
	 */
	public static $key = 'special-request';
	...
	protected static function subject( array $args = [] ) {
		...
		$subject = __( 'Special Request', 'gothic-selections' );
