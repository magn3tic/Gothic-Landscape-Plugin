<?php
/**
 * Selections Step "Access" Found Order Notification Email
 *
 ...
 * @abstract
 */
final class StepAccessFoundOrder extends MessageAbstract implements MessageInterface {
	 ...
	 * @var string
	 */
	public static $key = 'step-access-found-order';
	...
	protected static function subject( array $args = [] ) {
		...
		$subject = __( 'Access Your Landscape Selections', 'gothic-selections' );
