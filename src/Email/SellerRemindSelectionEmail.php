 ...
 * @abstract
 */
final class SellerRemindSelectionEmail extends MessageAbstract implements MessageInterface {
	...
	protected static function subject( array $args = [] ) {
		...
		$subject = __( 'Your Buyer Hasn\'t Completed Their Landscape Selection', 'gothic-selections' );
