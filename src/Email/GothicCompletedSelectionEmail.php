<?php
/**
 * Selections Complete (Gothic) Notification Email
 *
 ...
 * @abstract
 */
final class GothicCompletedSelectionEmail extends MessageAbstract implements MessageInterface {
	 ...
	 * @var string
	 */
	public static $key = 'completed-for-gothic';
	...
	protected static function recipients( array $args = [] ) {
		...
		$recipients = 'az.selections@gothiclandscape.com';
