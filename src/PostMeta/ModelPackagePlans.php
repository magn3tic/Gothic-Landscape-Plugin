...
final class ModelPackagePlans extends PostMetaAbstract {
	...
	public static function name() : string {
		...
		return __( 'Model Package Plans', 'gothic-selections' );
	}
	...
	public static function should_disable( bool $show, $post ) : bool {
		...
		if ( "1" !== get_post_meta( $community, 'frontyard', true ) ) {
			return true;
		}
