...
final class CommunityBackyards extends PostMetaAbstract {
	...
	public static function name() : string {
		...
		return __( 'Back Yard Packages', 'gothic-selections' );
	}
	...
	public static function render( WP_Post $post ) : void {
		$template_vars = [
			...
			'is_backyard'  => true,
			'packages'     => Queries::packages( [ 'community_id' => $post->ID, 'backyard' => 1 ], true ),
		];
	...
	public static function should_disable( bool $show, $post ) : bool {
		...
		if ( "1" !== get_post_meta( $post->ID, 'backyard', true ) ) {
			return true;
		}
