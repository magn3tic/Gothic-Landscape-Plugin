<?php
/**
 * Template Part : Select Landscape Packages Field
 *
...
<div class="<?php echo esc_attr( Template::classes( $class ) ); ?>">
	...
	<div class="field">
		...
		<select id="<?php echo esc_attr( $name ); ?>" name="<?php echo esc_attr( $name ); ?>" <?php echo Template::attributes( $attributes ); ?> >
			...
			<?php
			$communities = Queries::packages( [
				'community_id' => (int) $attributes['data-community'] ?: 0,
				'backyard'     => isset( $attributes['data-backyard'] ) ? (bool) $attributes['data-backyard'] : false,
			] );
			?>
